"""Daily-momentum-ranked MACD volume strategy."""
...
class MACDVolumeDailyRanked(DailyMomentumRankedMixin, MACDVolume):
    """MACDVolume with entries restricted to the daily momentum top 3."""
